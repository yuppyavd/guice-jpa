 ...
 *  - roll back on {@link TestError}.
 *  - throw a new {@link TestError}.
 *
 * @author Piotr Ostrowski
 */
public class TaskRollingBackOnNoneThrowingTestError extends TransactionalTask {
  ...
  @Override
  @Transactional
  public void doTransactional() throws TestException, RuntimeTestException, TestError {
    storeEntity(new TransactionTestEntity());
    doOtherTasks();
    throw new TestError(getClass().getSimpleName());
  }
